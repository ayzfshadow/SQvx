...
public class SQApplication extends CaptrueLogApplication/*MultiDexApplication*/ {
    public void onCreate() {
        super.onCreate();
        CrashHandler.getInstance().init(getApplicationContext());
        FileUtil.a((Context) this);
		//Handler.getInstance().init(getApplicationContext());
     ...
     * 崩溃日志存储路径
     */
    public static final String crashPath = Environment.getExternalStorageDirectory()+"/Android/data/com.ayzf.sqvx/cache/logs/";
    ...
    {
        return "/data/user/0/com.ayzf.sqvx/cache/logs/" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + ".log";
    }
